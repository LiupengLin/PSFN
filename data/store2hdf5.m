function [curr_dat1_sz, curr_dat2_sz, curr_lab_sz] = store2hdf5(filename, data1, data2, labels, create, startloc, chunksz)  
  ...
  if create
    ...
    if ~exist('startloc','var')
      ...
      assert(prev_dat2_sz(1:end-1)==dat1_dims(1:end-1), 'data2 dimensions must match existing dimensions in dataset');
